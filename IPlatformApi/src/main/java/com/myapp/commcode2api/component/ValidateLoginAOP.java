...
@Component
@Aspect
public class ValidateLoginAOP {
    @Autowired
    private CacheService cacheService;
    @Pointcut("@annotation(com.myapp.commcode2api.component.ValidateLogin)")
    ...
    public Object handle(ProceedingJoinPoint proceedingJoinPoint) throws Throwable{
        ...
        cacheService.traceLoginFailByIp(ip, DataOperateConstants.CACHE_CHECK);
