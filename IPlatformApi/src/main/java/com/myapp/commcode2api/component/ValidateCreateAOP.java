...
@Component
@Aspect
public class ValidateCreateAOP {
    @Autowired
    private CacheService cacheService;
    @Pointcut("@annotation(com.myapp.commcode2api.component.ValidateCreate)")
    ...
    public Object handle(ProceedingJoinPoint proceedingJoinPoint) throws Throwable{
        ...
        cacheService.traceCreateByIp(ip, DataOperateConstants.CACHE_CHECK);
